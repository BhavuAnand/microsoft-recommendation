...
// $("#personalcarebox").hide()

// $(document).ready(function(){
//   $("#hide").click(
  
  
//     $("#personalcarebox").css({"height" : "200px"})
//   )
...
// $("#personalcareheading").click(
//   function(){$("#personalcarebox").css({"visibility":"visible"});},
//   // function(){$("#personalcarebox").show();}
